...
<Mermaid title="สองแนวคิดที่เป็นรากฐานของทุกอย่าง" code={lensDiagram} />
...
ถ้ามาจาก code สไตล์ jQuery คุณจะคิดเป็น **mutation**: "พอ user คลิก ก็ไปหา element แล้วแก้ element นั้น" React ขอให้คุณคิดเป็น **snapshot** แทน: "สำหรับ state นี้ UI หน้าตาแบบนี้" คุณไม่แตะ DOM เลย คุณแค่เปลี่ยน state แล้วอธิบาย UI ใหม่ การพลิกมุมนี้ — จาก *จะ update อย่างไร* ไปเป็น *UI ควรเป็นอะไร* — คือหัวใจทั้งหมด
</Callout>
...
export const quizIndex = [
  ...
  },
  {
    ...
    options: [
      'หา DOM node แล้ว mutate โดยตรง',
  ...
  },
  {
    ...
    options: [
      ...
      'เพื่อให้ React เรียก component ได้อย่างอิสระ — batch, restart หรือเรียกซ้ำสองครั้ง — ซึ่งทำให้ concurrent features เป็นไปได้',
