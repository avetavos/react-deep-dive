...
หลายปีที่ผ่านมา คำตอบมาตรฐานของ "เริ่ม React app ยังไง?" คือ Create React App (CRA) ยุคนั้นจบแล้ว: ทีม React **deprecated CRA อย่างเป็นทางการในปี 2025** ตอนนี้ติดตั้งมันจะขึ้น warning ชี้ไปยังตัวเลือกปัจจุบัน อย่าเริ่มโปรเจกต์ใหม่ด้วยมัน และควรพิจารณาย้ายโปรเจกต์เดิมออก
...
export const quizProject = [
  ...
  },
  {
    ...
    options: [
      ...
      'มัน import แบบ global ผ่าน script tag',
    ],
    answer: 1,
  },
];
